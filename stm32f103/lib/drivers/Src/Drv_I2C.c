...
void I2C_EV_IRQHandling(I2C_Handle_t* pI2CHandle)
{
    ...
    if (I2C_GetFlagStatus(pI2CHandle->pI2Cx->SR1, I2C_SR1_TXE) && I2C_GetFlagStatus(pI2CHandle->pI2Cx->CR2, I2C_CR2_ITEVTEN) &&
        I2C_GetFlagStatus(pI2CHandle->pI2Cx->CR2, I2C_CR2_ITBUFEN))
    {
    ...
    if (I2C_GetFlagStatus(pI2CHandle->pI2Cx->SR1, I2C_SR1_RXNE) && I2C_GetFlagStatus(pI2CHandle->pI2Cx->CR2, I2C_CR2_ITEVTEN) &&
        I2C_GetFlagStatus(pI2CHandle->pI2Cx->CR2, I2C_CR2_ITBUFEN))
    {
        // Handle Transmit Buffer Empty event
        if (pI2CHandle->RxLen == 1)
